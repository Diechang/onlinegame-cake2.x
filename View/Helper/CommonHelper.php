 ...
 * @access	public
 */
	function titleSeparatedDiv($title_official, $title_read = null)
	{
		$title = '<div class="official">' . $title_official . '</div>';
		if(!empty($title_read))
		{
			$title .= '<div class="read">' . $title_read . '</div>';
		}
 ...
 * @access	public
 */
	function titleLinkUrl($path = null, $action = "index", $hash = null)
	{
		return $this->Html->url(array("controller" => "titles", "action" => $action, "path" => $path, "ext" => "html", "#" => $hash));
	}
