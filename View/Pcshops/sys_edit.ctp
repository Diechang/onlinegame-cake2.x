<?php echo $form->create("Pcshop" , array("action" => "edit" , "inputDefaults" => array("div" => false , "label" => false , "cols" => null , "rows" => null)))?>
	<h2>ショップ編集</h2>
	<table class="edit spec table table-bordered">
		<tr>
			<th nowrap="nowrap">ID</th>
			<td><?php echo $this->data["Pcshop"]["id"]?><?php echo $form->hidden("id")?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<div><?php echo $this->data["Pcshop"]["ad_text"]?></div>
				<?php echo $form->input("ad_text" , array("class" => "adField focusSelect" , "rows" => 4))?>
			</td>
		</tr>
		<tr>
