...
//set blocks
$this->assign("title", $titleWithStrs["Abbr"] . " 動画（ムービー）・ブログ記事検索");
...
$this->assign("description", $titleWithStrs["Sub"] . "の動画（ムービー）・ブログ記事検索です。");
//pankuz
$this->set("pankuz_for_layout", array(array("str" => $titleWithStrs["Case"], "url" => array("action" => "index", "path" => $title["Title"]["url_str"], "ext" => "html")), "動画・ブログ検索"));
//OGP
