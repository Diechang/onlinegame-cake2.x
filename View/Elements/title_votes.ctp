...
<div class="items">
	...
	<div class="item">
		...
		<h3><?php echo $this->Html->link($this->Common->voteTitle($vote["Vote"]) , $url, (empty($vote["Vote"]["review"]) ? array("rel" => "nofollow") : null))?></h3>
		<div class="body">
			<div class="total">
			...
			<p class="text">
				<?php echo (!empty($vote["Vote"]["review"])
					? ($all)
						...
						: mb_strimwidth(h($vote["Vote"]["review"]), 0, 200, " … " . $this->Html->link("続き" , array("action" => "single" , "path" => $titlePath , "voteid" => $vote["Vote"]["id"] , "ext" => "html")))
