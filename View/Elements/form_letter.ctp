...
<?php echo $this->Form->create("Letter", array("action" =>"add", "inputDefaults" => array("div" => false, "label" => false, "legend" => false)))?>
	<table class="formTable">
		<tr>
			<th>お名前（HN）</th>
			<td><?php echo $this->Form->input("name", array("class" => "formText"))?></td>
		</tr>
		<tr>
			<th>メールアドレス</th>
			<td><?php echo $this->Form->input("mail", array("class" => "formText"))?></td>
		</tr>
		<tr>
			<th>本文</th>
			<td><?php echo $this->Form->input("body", array("rows" => "6", "class" => "formText"))?></td>
		</tr>
		<tr>
			<th>認証番号</th>
		...
		<tr>
			...
			<?php echo $this->Form->button("お問合せ送信", array(
				"type" => "submit",
				"class" => "button"))?></td>
		</tr>
	</table>
