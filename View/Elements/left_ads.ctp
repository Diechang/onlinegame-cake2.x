...
<div class="leftBox leftAds">
	...
	<div class="body">
		...
		<p>Xbox360の人気シリーズがカジュアル横スクロールアクションに！<br />12月8日正式サービス開始!!</p>
	</div>
	<!--
	<div class="body">
		...
		<p>かわいすぎる「みんなのオンラインRPG」。<br />11月22日正式サービス開始!!</p>
	</div>
	 -->
	<!--
	<div class="body">
		...
		<p>難航不落の王道RPG。<br />やり直しのきかない世界が遂にオープンβ開始!!</p>
	</div>
	 -->
	<!-- 
	<div class="body">
		...
		<p>2.5Dの北欧神話MMORPG。<br />オープンβテスト開始!!</p>
	</div>
	 -->
</div>
