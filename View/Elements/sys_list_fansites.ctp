...
?>
		<tr class="title_id_<?php echo $fansite["Fansite"]["title_id"]?>">
			<td class="tCenter" nowrap="nowrap"><?php echo $this->Html->link("編集" , array("controller" => "fansites" , "action" => "edit" , $fansite["Fansite"]["id"]) , array("class" => "btn"))?></td>
			<td class="tCenter">
				<?php echo $this->Form->checkbox("Fansite." . $key . ".public" , array("checked" => (!empty($fansite["Fansite"]["public"]))))?>
				<?php echo $this->Form->hidden("Fansite." . $key . ".id" , array("value" => $fansite["Fansite"]["id"]))?>
				<?php echo $this->Form->hidden("Fansite." . $key . ".title_id" , array("value" => $fansite["Fansite"]["title_id"]))?>
			</td>
			...
			<td class="tCenter" nowrap="nowrap"><?php echo $this->Html->link("<i class='icon-remove icon-white'></i> 削除" , array("controller" => "fansites" , "action" => "delete" , $fansite["Fansite"]["id"]) , array("class" => "btn btn-danger btn-small" , "escape" => false) , $fansite["Fansite"]["site_name"] . " を削除しますか?")?></td>
		</tr>
<?php endforeach;?>
	</tbody>
</table>