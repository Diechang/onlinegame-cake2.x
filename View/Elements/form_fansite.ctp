				...
				<td colspan="2">
					<dl>
						...
						<dd>
							...
							<input type="text" class="url" onclick="this.select()" value="<?php echo $this->Html->url(array("controller" => "titles", "action" => "index", "path" => $title["Title"]["url_str"], "ext" => "html"), true)?>"></p>
