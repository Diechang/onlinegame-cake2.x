...
<?php if($title["Title"]["votable"]):?>
			<tr>
				...
				<td>
					...
					/ <a href="<?php echo $this->Html->url(array("action" => "review", "path" => $title["Title"]["url_str"], "ext" => "html"))?>">レビュー：<span<?php echo $this->RichSnippets->property("count")?>><?php echo $this->Common->countFormat($title["Titlesummary"]["vote_count_review"])?></span>件</a>
					/ <a href="<?php echo $this->Html->url(array("action" => "rating", "path" => $title["Title"]["url_str"], "ext" => "html"))?>">評価：<span<?php echo $this->RichSnippets->property("votes")?>><?php echo $this->Common->countFormat($title["Titlesummary"]["vote_count_vote"])?></span>件</a>
				</td>
			</tr>
<?php endif;?>
		</table>
