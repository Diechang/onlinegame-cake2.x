...
<div class="rightBox rightMyreview">
	<h2><?php echo $this->Html->image("design/rightbox_myreview_title.gif" , array("alt" => "最近投稿したレビュー・評価"))?></h2>
	<div class="comment"><?php echo $this->Html->image("design/rightbox_myreview_comment.gif" , array("alt" => "パスワードがあればいつでも編集できます"))?></div>
	<div class="body">
<?php foreach($rightVoted as $rightVote):?>
	...
	<?php if(!empty($rightVote["Vote"]["pass"])):?>
			<p class="edit"><?php echo $this->Html->link("投稿を編集する" , array("controller" => "votes" , "action" => "edit" , $rightVote["Vote"]["id"]) , array("rel" => "nofollow"))?></p>
	<?php endif;?>
