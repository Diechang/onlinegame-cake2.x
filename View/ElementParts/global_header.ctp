<!-- Header -->
<div id="header">
	<div class="logo"><?php echo $this->Html->image("design/logo_top.gif", array("alt" => "【オンラインゲームライフ】-無料オンラインゲーム情報-", "url" => "/"));?></div>
	<!-- Main Nav -->
...
*/ ?>
		<li><?php echo $this->Html->link("ゲームポータル", array("controller" => "portals", "action" => "index", "ext" => "html"))?></li>
		<li class="hasChild">
	...
	<?php endforeach;?>
		...
		<li class="search"><?php echo $this->Html->link("検索", array("controller" => "search", "action" => "index"))?></li>
	</ul>
	<ul id="addBookmark">
		<li><a href="javascript:void(0)" onclick="SBM.browser()"><?php echo $this->Html->image("design/addbookmark_browser.gif", array("alt" => "お気に入りに追加"))?></a></li>
		<li><a href="javascript:void(0)" onclick="SBM.yahoo()"><?php echo $this->Html->image("design/addbookmark_yahoo.gif", array("alt" => "Yahooブックマーク"))?></a></li>
		<li><a href="javascript:void(0)" onclick="SBM.hatena()"><?php echo $this->Html->image("design/addbookmark_hatena.gif", array("alt" => "はてなブックマーク"))?></a></li>
	</ul>
	<div id="googleSearch">
