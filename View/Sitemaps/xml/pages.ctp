...
<!--ランキング-->
<url><loc><?php echo $domain . $this->Html->url(array("controller" => "ranking" , "path" => "index" , "ext" => "html"))?></loc></url>
<?php foreach($categories as $category):?>
<url><loc><?php echo $domain . $this->Html->url(array("controller" => "ranking" , "path" => $category["Category"]["path"] , "ext" => "html"))?></loc></url>
<?php endforeach;?>

<!--ジャンル別-->
<?php foreach($categories as $category):?>
<url><loc><?php echo $domain . $this->Html->url(array("controller" => "categories" , "path" => $category["Category"]["path"] , "ext" => "html"))?></loc></url>
<?php endforeach;?>

<!--スタイル・環境別-->
<?php foreach($styles as $style):?>
<url><loc><?php echo $domain . $this->Html->url(array("controller" => "styles" , "path" => $style["Style"]["path"] , "ext" => "html"))?></loc></url>
<?php endforeach;?>

<!--サービス状態別-->
<?php foreach($services as $service):?>
<url><loc><?php echo $domain . $this->Html->url(array("controller" => "services" , "path" => $service["Service"]["path"] , "ext" => "html"))?></loc></url>
<?php endforeach;?>
...
<!--ポータル-->
<url><loc><?php echo $domain . $this->Html->url(array("controller" => "portals" , "action" => "index" , "ext" => "html"))?></loc></url>
<?php foreach($portals as $portal):?>
<url><loc><?php echo $domain . $this->Html->url(array("controller" => "portals" , "action" => "view" , "path" => $portal["Portal"]["url_str"] , "ext" => "html"))?></loc></url>
<?php endforeach;?>

<!--ゲーム代を稼ぐ-->
<url><loc><?php echo $domain . $this->Html->url(array("controller" => "monies" , "action" => "index" , "ext" => "html"))?></loc></url>
<?php foreach($moneycategories as $moneycategory):?>
<url><loc><?php echo $domain . $this->Html->url(array("controller" => "monies" , "action" => "view" , "path" => $moneycategory["Moneycategory"]["path"] , "ext" => "html"))?></loc></url>
<?php endforeach;?>

<!--ゲーム用PC-->
<url><loc><?php echo $domain . $this->Html->url(array("controller" => "pcs" , "action" => "index" , "ext" => "html"))?></loc></url>
