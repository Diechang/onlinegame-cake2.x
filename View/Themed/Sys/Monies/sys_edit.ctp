<?php echo $this->Form->create("Money", array("url" => array("action" => "add"), "inputDefaults" => array("div" => false, "label" => false, "legend" => false)))?>
	<table class="edit table table-bordered">
		<tr>
			<th nowrap="nowrap">ID</th>
			<td><?php echo $this->request->data["Money"]["id"]?><?php echo $this->Form->hidden("id")?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<?php echo $this->request->data["Money"]["ad_text"]?><br />
		...
		<tr>
			...
			<td>
				<?php echo $this->request->data["Money"]["ad_banner"]?><br />
