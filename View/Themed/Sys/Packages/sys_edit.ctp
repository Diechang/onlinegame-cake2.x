<?php echo $this->Form->create("Package", array("action" => "edit", "inputDefaults" => array("div" => false, "label" => false, "monthNames" => false, "dateFormat" => "YMD", "minYear" => 1990, "maxYear" => date("Y") + 2)))?>
	...
	<table class="edit table table-bordered">
		<tr>
			...
			<td><?php echo $this->request->data["Package"]["id"]?><?php echo $this->Form->hidden("id")?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<div class="adText"><?php echo $this->request->data["Package"]["ad_src_text"]?></div>
		...
		<tr>
			...
			<td>
				<div class="adImage"><?php echo $this->request->data["Package"]["ad_src_image"]?></div>
