<?php echo $this->Form->create("Vote", array("url" => array("action" => "index"), "type" => "get", "inputDefaults" => array("div" => false, "label" => false)))?>
...
<?php echo $this->Form->create("Vote", array("url" => array("action" => "lump")))?>
	<h2>投稿一覧</h2>
