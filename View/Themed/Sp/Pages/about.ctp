...
<section class="about-doc">
	...
	<section class="about-doc">
		...
		<p>当サイトでは、Javascript、Cookieを有効にしてご覧ください。</p>
		...
		<section>
			...
			<p>このプロセスの詳細やこのような情報が広告配信事業者に使用されないようにする方法については、<a href="http://www.google.com/ads/preferences" class="inline" target="_blank">ここ</a>（Google Ads   Preferences）をクリックしてください。 </p>
		</section>
		<section>
			<h2>ゲーム内容について</h2>
	...
	<section class="about-doc">
		...
		<p><img src="/img/banner8831.gif" alt="【オンラインゲームライフ】バナー" /><br>
		手抜きですけどバナーです。（88×31px）<br>
		※ダウンロードしてご利用ください。</p>
		<section>
			<h3>相互リンクについて</h3>
			<p>相互リンクをご希望の方は、<?php echo $this->Html->link("相互リンク依頼フォーム", array("controller" => "links", "path" => "index", "ext" => "html", "#" => "form"), array("class" => "inline"))?>からご登録をお願いします。<br>
