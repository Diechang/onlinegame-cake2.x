	...
	<footer>
			...
			<div class="navigations-body">
				<nav>
					<ul>
						...
						<li><a href="<?php echo $this->Html->url(array("controller" => "mode", "action" => "sp", "ext" => "html", "sp" => false))?>"><i class="zmdi zmdi-smartphone"></i> スマートフォン版</a></li>
					</ul>
				...
				<div class="rankings">
					<div class="access">
						...
						<div class="ranking"><script src="//pranking8.ziyu.net/js/diechang.js"></script></div>
					</div>
					<div class="page">
						<h2>
						...
						<div class="ranking"><script src="//rranking12.ziyu.net/js/diechang.js"></script></div>
					</div>
				</div>
			</div>
		</div>
		<div class="copyright">
			<div class="copyright-body">
				...
				<a href="http://www.ziyu.net/" target="_blank"><img src="//file.ziyu.net/rranking.gif" alt="アクセスランキング" border="0" width="35" height="11"></a>
				<a href="http://www.ziyu.net/" target="_blank"><img src="//pranking8.ziyu.net/img.php?diechang" alt="ブログパーツ" border="0" width="35" height="11"></a></p>
