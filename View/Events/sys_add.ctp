<?php echo $this->Form->create("Event" , array("action" => "add" , "inputDefaults" => array("div" => false , "label" => false , "monthNames" => false , "dateFormat" => "YMD" , "timeFormat" => "24" , "minYear" => 1990 , "maxYear" => date("Y") + 2)))?>
	<h2>イベント登録</h2>
