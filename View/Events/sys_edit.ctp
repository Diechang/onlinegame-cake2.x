<?php echo $form->create("Event" , array("action" => "edit" , "inputDefaults" => array("div" => false , "label" => false , "monthNames" => false , "dateFormat" => "YMD" , "timeFormat" => "24" , "minYear" => 1990 , "maxYear" => date("Y") + 2)))?>
	<h2>イベント編集</h2>
	<table class="edit event table table-bordered">
		<tr>
			<th nowrap="nowrap">ID</th>
			<td><?php echo $this->data["Event"]["id"]?><?php echo $form->hidden("id")?></td>
		</tr>
		<tr>
