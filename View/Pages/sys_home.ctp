...
<h3>
	...
	<?php echo $this->Form->create("Title" , array("action" => "index" , "type" => "get" , "inputDefaults" => array("div" => false , "label" => false)))?>
		<?php echo $this->Form->text("w" , array("size" => 10))?>
		<?php echo $this->Form->select("category", $categories , null , array("empty" => "-カテゴリ-"))?>
		<?php echo $this->Form->select("service", $services , null , array("empty" => "-サービス-"))?>
		<?php echo $this->Form->submit("タイトル検索" , array("div" => false , "class" => "btn"))?>
	<?php echo $this->Form->end()?>
</h3>

<?php echo $this->Form->create("Title" , array("controller" => "titles" , "action" => "lump"))?>
...
?>
<!-- Votes -->
<?php echo $this->Form->create("Vote" , array("controller" => "votes" , "action" => "lump"))?>
...
<!--  -->
<!-- Fansites -->
<?php echo $this->Form->create("Fansite" , array("controller" => "fansites" , "action" => "lump"))?>
...
<!--  -->
<!-- Packages -->
<?php echo $this->Form->create("Package" , array("controller" => "packages" , "action" => "lump"))?>
...
<!--  -->
<!-- Pcs -->
<?php echo $this->Form->create("Pc" , array("controller" => "pcs" , "action" => "lump"))?>
...
<!--  -->
<!-- Links -->
<?php echo $this->Form->create("Link" , array("controller" => "links" , "action" => "lump"))?>
