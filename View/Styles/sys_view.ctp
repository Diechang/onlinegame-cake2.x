...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(sprintf(__('Edit %s'), __('Style')), array('action' => 'edit', $style['Style']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('Delete %s'), __('Style')), array('action' => 'delete', $style['Style']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $style['Style']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('List %s'), __('Styles')), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('New %s'), __('Style')), array('action' => 'add')); ?> </li>
